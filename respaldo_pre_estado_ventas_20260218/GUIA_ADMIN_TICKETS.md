...
- **Administrador (todo):** una sola clave configurada en el servidor (ADMIN_SECRET). Necesaria para: imprimir por día, tickets regalo, stock y precios, informe 20 Feb.
